    ...
    class Test
    {
        ...
        */
        ...
        public void test21()
        {
            ...
            Debug.Assert(SDM.LMS.OverdueTime(SDM.LMS.GetPatronByName("p1").userID, SDM.LMS.GetDocID("d1")) == 0);
            Debug.Assert(SDM.LMS.OverdueTime(SDM.LMS.GetPatronByName("p1").userID, SDM.LMS.GetDocID("d2")) == 0);
            Debug.Assert(SDM.LMS.GetUserFineForDoc(SDM.LMS.GetPatronByName("p1").userID, SDM.LMS.GetDocID("d1")) == 0);
            ...
            Debug.Assert(SDM.LMS.OverdueTime(SDM.LMS.GetPatronByName("s").userID, SDM.LMS.GetDocID("d1")) == 7);
            Debug.Assert(SDM.LMS.OverdueTime(SDM.LMS.GetPatronByName("s").userID, SDM.LMS.GetDocID("d2")) == 14);
            ...
            Debug.Assert(SDM.LMS.OverdueTime(SDM.LMS.GetPatronByName("v").userID, SDM.LMS.GetDocID("d1")) == 21);
            Debug.Assert(SDM.LMS.OverdueTime(SDM.LMS.GetPatronByName("v").userID, SDM.LMS.GetDocID("d2")) == 21);
        ...
        public void test22()
        {
            ...
            Debug.Assert(SDM.LMS.CheckoutTimeToBack(SDM.LMS.GetPatronByName("p1").userID, SDM.LMS.GetDocID("d1")).Day == 2); 

            Debug.Assert(SDM.LMS.CheckoutTimeToBack(SDM.LMS.GetPatronByName("s").userID, SDM.LMS.GetDocID("d2")).Day == 18);

            Debug.Assert(SDM.LMS.CheckoutTimeToBack(SDM.LMS.GetPatronByName("v").userID, SDM.LMS.GetDocID("d2")).Day == 11);
        ...
        public void test23()
        {
            ...
            Debug.Assert(SDM.LMS.CheckoutTimeToBack(SDM.LMS.GetPatronByName("s").userID, SDM.LMS.GetDocID("d2")).Day == 4);

            Debug.Assert(SDM.LMS.CheckoutTimeToBack(SDM.LMS.GetPatronByName("v").userID, SDM.LMS.GetDocID("d2")).Day == 4);
